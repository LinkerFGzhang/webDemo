...
<form id="testPutOrDelete" action="/testPut" method="post">
    <input type="hidden" name="_method" value="PUT">
    <a href="/testPut" onclick="test(this)"> submit</a>
</form>

<script type="text/javascript">
    function test(obj) {
        var href = "${pageContext.request.contextPath}" + $(obj).attr("href");
        alert(href);
        $("#testPutOrDelete").submit();
    }
</script>
